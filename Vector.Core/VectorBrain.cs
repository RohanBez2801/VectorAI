...
public class VectorBrain : IDisposable
{
        ...
        Func<string, Task<bool>>? userConfirmation = null)
    {
        ...
        // Core System Tools
        builder.Plugins.AddFromObject(new FileSystemPlugin(fileApproval, _verifier, _governor), "FileSystem");
        builder.Plugins.AddFromObject(new ShellPlugin(shellApproval, _verifier, _governor), "Shell");
        ...
        builder.Plugins.AddFromObject(new DeveloperConsolePlugin(shellApproval, fileApproval, _verifier, _governor), "DeveloperConsole");
